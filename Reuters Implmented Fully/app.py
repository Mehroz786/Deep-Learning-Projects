...
flask is used to link the pickle file to the html file
"""
...
def predict():
    ...
    category = results[0]
    percentage = round(results[1],2)
    return  render_template("index.html",category = category  , percentage = percentage)
